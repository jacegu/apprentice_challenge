...
The engine also takes a few things for granted that every feed item has a *title*, a *description*, an <b>encoded content</b> (based on the RSS extension http://purl.org/rss/1.0/modules/content) and a *pubDate*.
