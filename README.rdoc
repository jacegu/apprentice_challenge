...
The engine also takes a few things for granted:
* That every feed item has a *title*
* That every feed item has a *description*
* That every feed item has an <b>encoded content</b> (based on the RSS extension http://purl.org/rss/1.0/modules/content)
* That every feed item has a *pubDate*
